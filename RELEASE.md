...
2. The workflow will:
   ...
   - Update `release.yaml` with version `0.17.0`
...
LIMITADOR_VERSION=v0.X.Y
IMAGE_TAG=v0.17.0
IMG=quay.io/kuadrant/limitador-operator:v0.17.0
BUNDLE_IMG=quay.io/kuadrant/limitador-operator-bundle:v0.17.0
CATALOG_IMG=quay.io/kuadrant/limitador-operator-catalog:v0.17.0
CHANNELS=stable
...
4. Check the version:
```sh
kubectl -n limitador-system get deployment limitador-operator-controller-manager --show-labels
```
